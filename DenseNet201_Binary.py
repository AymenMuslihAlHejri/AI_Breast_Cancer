...
def create_model(input_shape, n_classes, dense=1024, fine_tune=0):
    ...
    base_model = DenseNet201(weights='imagenet',input_shape=(image_size, image_size, 3))

    
    model = Model(base_model.input, outputs=outputs, name="EfficientNetDenseNet291")
...
history = DenseNet201_Binary_model_ft.fit(training_set, validation_data=validating_set, epochs=5,callbacks=[tl_checkpoint_1],verbose=1) #30
...
DenseNet201_Binary_model_ft.evaluate(training_set)

DenseNet201_Binary_model_ft.evaluate(validating_set)
...
DenseNet201_Binary_model_ft.evaluate(testing_set)
...
Y_pred2 = DenseNet201_Binary_model_ft.predict(testing_set)
...
Y_pred3 = DenseNet201_Binary_model_ft.predict(testing_set1)
